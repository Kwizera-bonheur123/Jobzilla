      ...
      <div className=" flex justify-between items-center h-full">
        ...
        <div className=" flex justify-center items-end gap-3">
          <div className=" flex cursor-pointer">
            ...
            <div className=" bg-blue-700 text-white px-[5px] py-[2px] -mt-3 -ml-1 h-fit rounded-full text-xs">4</div>
          </div>
          <div className=" flex cursor-pointer">
            <IoMdNotificationsOutline size='24px'/>
            <div className=" bg-blue-700 text-white px-[5px] py-[2px] -mt-3 -ml-2 h-fit rounded-full text-xs">8</div>
          </div>
          <div onClick={() => setProfileModel(!profileModel)} className=" flex justify-center items-center gap-3 cursor-pointer">
